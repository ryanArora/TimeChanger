package me.mynameryan.timechanger.asm.transformers;

import me.mynameryan.timechanger.asm.ITransformer;
...
public class ActiveRenderInfoTransformer implements ITransformer {
    private static final String HOOK_CLASS = "me/mynameryan/timechanger/asm/hooks/ActiveRenderInfoHook";
